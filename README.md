...
[![Latest Release](https://img.shields.io/badge/release-v4.4.1--stable-blue?style=flat-square)](https://github.com/SuamiSihat/ss_cam/releases/tag/v4.4.1)
...
|---|---|---|---|
| 🪟 **Windows 10 / 11** | **Native WPF Single-File** | No install required. Run portable executable: <br> `.\SS-CAM-v4.4.1.exe` | [Download SS-CAM-v4.4.1.exe](https://github.com/SuamiSihat/ss_cam/releases/download/v4.4.1/SS-CAM-v4.4.1.exe) |
