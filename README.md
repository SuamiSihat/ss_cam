...
[![Latest Release](https://img.shields.io/badge/release-v4.0.0--stable-blue?style=flat-square)](https://github.com/SuamiSihat/ss_cam/releases/tag/v4.0.0)
...
SS-CAM eliminates project disorganization, scattered copywriting drafts, inconsistent brand palettes, and untracked deliverable approvals by providing a standardized filesystem vault hierarchy, a Markdown-as-database architecture, an in-app Copywriting Studio, and multi-platform collaboration tools.
...
|---|---|---|---|
| 🪟 **Windows 10 / 11** | **Native WPF Single-File** | No install required. Run portable executable: <br> `.\SS-CAM-v4.0.0.exe` | [Download SS-CAM-v4.0.0.exe](https://github.com/SuamiSihat/ss_cam/releases/download/v4.0.0/SS-CAM-v4.0.0.exe) |
