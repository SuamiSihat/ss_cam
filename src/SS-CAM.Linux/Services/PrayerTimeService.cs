        ...
        public static async Task<List<PrayerTimeRow>> GetPrayerTimesAsync(string zone = "WLY01")
        {
            try
            {
                ...
                if (result != null && result.Length > 0)
                {
                    ...
                    {
                        new() { Name = "Imsak", Time = r.Imsak ?? "05:45", Description = "Waktu penahanan sebelum fajar" },
                        new() { Name = "Subuh", Time = r.Subuh ?? "05:55", Description = "Solat fardhu 2 rakaat" },
                        new() { Name = "Syuruk", Time = r.Syuruk ?? "07:08", Description = "Terbit matahari" },
                        new() { Name = "Dhuha", Time = r.Dhuha ?? "07:35", Description = "Solat sunat Dhuha" },
                        new() { Name = "Zohor", Time = r.Zohor ?? "13:18", Description = "Solat fardhu 4 rakaat" },
                        new() { Name = "Asar", Time = r.Asar ?? "16:25", Description = "Solat fardhu 4 rakaat" },
                        new() { Name = "Maghrib", Time = r.Maghrib ?? "19:22", Description = "Solat fardhu 3 rakaat" },
                        new() { Name = "Isyak", Time = r.Isyak ?? "20:32", Description = "Solat fardhu 4 rakaat" }
                    };
                }
            }
            catch (Exception ex)
            ...
            return new List<PrayerTimeRow>
            {
                new() { Name = "Imsak", Time = "05:45", Description = "Waktu penahanan sebelum fajar" },
                new() { Name = "Subuh", Time = "05:55", Description = "Solat fardhu 2 rakaat" },
                new() { Name = "Syuruk", Time = "07:08", Description = "Terbit matahari" },
                new() { Name = "Dhuha", Time = "07:35", Description = "Solat sunat Dhuha" },
                new() { Name = "Zohor", Time = "13:18", Description = "Solat fardhu 4 rakaat" },
                new() { Name = "Asar", Time = "16:25", Description = "Solat fardhu 4 rakaat" },
                new() { Name = "Maghrib", Time = "19:22", Description = "Solat fardhu 3 rakaat" },
                new() { Name = "Isyak", Time = "20:32", Description = "Solat fardhu 4 rakaat" }
            };
        }
